...
const AboutContent = () => {
  return (
    <ContentContainer>
      <AboutContentDetail contentID={1} contentImage={contentImageRibbon.src} contentTitle="Do not wait more" contentDescription="언제, 어디서나 당신은 훌륭한 그림책 작가가 될 수 있습니다. 지금 토링과 함께하세요." />
      ...
      <AboutContentDetail contentID={3} contentImage={contentImageHat.src} contentTitle="Life comes story, Story comes life" contentDescription="토링은 당신의 특별한 삶을 이야기로 만들어 드립니다. 당신의 이야기로 더 많은 사람들에게 특별한 삶을 선물해주세요" />
    </ContentContainer>
  );
}
